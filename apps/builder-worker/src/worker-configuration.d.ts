/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 2688a76d781e8d22bb2b92fba2007cc0)
// Runtime types generated with workerd@1.20251011.0 2025-10-24 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "BuilderContainer" | "BuilderOrchestrator";
	}
	interface Env {
		BUILDER_CONTAINER: DurableObjectNamespace<import("./index").BuilderContainer>;
		BUILDER_ORCHESTRATOR: DurableObjectNamespace<import("./index").BuilderOrchestrator>;
		DOCS_DB: D1Database;
	}
}
