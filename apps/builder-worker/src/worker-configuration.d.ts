/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 4b84f1df26328b33e941198b82ee53bf)
// Runtime types generated with workerd@1.20251011.0 2025-10-24 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "BuilderContainer" | "BuilderManager";
	}
	interface Env {
		BUILDER_CONTAINER: DurableObjectNamespace<import("./index").BuilderContainer>;
		BUILDER_MANAGER: DurableObjectNamespace<import("./index").BuilderManager>;
		DOCS_DB: D1Database;
	}
}
